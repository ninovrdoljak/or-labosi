...
public class ZupanijaReqDTO {
	...
	public ZupanijaReqDTO(String naziv, String sjediste, int stanovnistvo, int brojgradova, int brojopcina,
			int brojnaselja, int povrsina, String zupan, String wikipoveznica, int gdppercapita) {
		super();
